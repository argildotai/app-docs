...
<CardGroup cols={2}>
  ...
  <Card title="Store your assets" icon="wand-magic-sparkles" color="purple" href="https://docs.argil.ai/resources/assets">
...
<Card title="API Documentation" icon="code" color="purple" href="https://docs.argil.ai/pages/get-started/introduction">
