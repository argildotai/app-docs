...
| Video                                             | $0.4/minute      |
| Voice                                             | $0.1/minute      |
| Royalty (Argil's avatars only)                    | $0.1/video       |
| B-roll (AI image or stock video)                  | $0.03/b-roll     |

<Note>
  For a 30 second video with 3 b-rolls and Argil avatar, the cost will be $0.2 (video) + $0.05 (voice) + $0.1 (royalty) + $0.09 (b-rolls) = $44 cts.&#x20;
</Note>
