...
<Steps>
  <Step title="Pick your avatar">
    Chose among our public avatars (horizontal and vertical format) and using the different tags.  You can chose among normal or pro avatars (which have been selected for their highest quality and are available on the pro plan).And of course, you can pick your own!
  </Step>
