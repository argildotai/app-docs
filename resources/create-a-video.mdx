...
<Steps>
  <Step title="Pick your avatar">
    Chose among our public avatars (horizontal and vertical format) and using the different tags.  And of course, you can pick your own!
  </Step>
  ...
  <Step title="Magic editing: pick your options" stepNumber={3}>
    You can chose your voice, toggle captions, pick a B-rolls type and layouts ([doc here](https://docs.argil.ai/resources/layouts)). You can pick a background music to have a pre-edited video rapidly. \
