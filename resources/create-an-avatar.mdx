...
2. **All of your face should be within the frame**
2. **The closer you are to the camera, the better the output will be**
2. **Please upload 720p minimum, 1080p ideally**

<Expandable title="Example of pictures you need to input">
  ![1MM Fue XB Ca Dk3v7ag BWLY](/images/1MMFueXBCaDK3v7agBWLY.png)

  ![Enhanced Image (9) 2](/images/enhanced-image\(9\)2.jpeg)

  ![Hq ZMMQ D9ai Xn Ss2m FJ E](/images/hqZMMQ-D9AiXnSs2mFJ_e.png)
</Expandable>
