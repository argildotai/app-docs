---
title: "Editing tips"
description: "Some tips regarding a good editing"
---
...
<Card title="Create an avatar with body language" icon="bolt" color="purple" horizontal={1}>
  Your AI avatar will be <u>much more engaging</u> if it can convey more expressivity through expressions and movement. Thankfully, our Pro clients can add body language & expressivity segments to their avatars.
</Card>

<Card title='Use a "Pro voice"' icon="robot" color="purple" horizontal={1}>
  To have a voice <u>that respects your tone and emotion</u>, we advise recording a "pro voice" and linking it to your avatar.
</Card>

<Card title="Record your voice instead of typing text" icon="volume" color="purple" horizontal={1}>
...
<Card title="Add music" icon="music" color="purple" horizontal={1}>
