...
<Note>
  ...
  70 (_video_)\\+ 10 (voice) + 20 (royalty) + 30 (b-rolls) =  130 credits$0.35 (video) \+ $
</Note>
...
<AccordionGroup>
  <Accordion defaultOpen="false" title="Can I avoid paying for voice?">
  ...
  <Accordion defaultOpen="false" title='What is the "avatar royalty"?'>
  ...
  <Accordion defaultOpen="false" title="Why do I need to subscribe to a plan for the API?">
  ...
  <Accordion defaultOpen="false" title="How to buy credits?">
