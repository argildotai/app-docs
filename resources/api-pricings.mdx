...
| Video                                             | 0.7 credits/minute  |
| Voice                                             | 0.33 credits/minute |
| Royalty (Argil's avatars only)                    | 0.33 credits/video  |
| B-roll (AI image)                                 | 0.17 credit/b-roll  |
| B-roll (stock video)                              | 0.33 credit/b-roll  |

<Note>
  For a 30 second video with 3 b-rolls and Argil avatar, the credit cost will be \
  0.35(_video_)\\\+ 0.1 (voice) \+ 0.33(royalty)\+0.09 (b-rolls) = 0.87 credits$0.35 (video) \+ $
</Note>
